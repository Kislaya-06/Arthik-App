...
## Full APK Build (New Binaries)

Required ONLY when making changes to native code, adding new native plugins (like `expo-image-picker`), or altering `app.json` configurations (like package names or splash screens).
